...
public class ResourceController {
    ...
    @Autowired
    private KafkaTemplate<String, String> queuePublish;
    ...
    public Resource createResource(@RequestBody Resource resource) {
        ...
        try {
            queuePublish.send("citizendemo", resource.resourceId);
            logger.info("createResource published resourceId to queue " + createdResource.resourceId);
        } catch (Exception e) {
